...
class Transaction(models.Model):
    ...
    cree_par_id_utilisateur = models.ForeignKey(Utilisateur, on_delete=models.SET_NULL, null=True, related_name='transactions')
...
class LigneTransaction(models.Model):
    id_transaction = models.ForeignKey(Transaction, on_delete=models.CASCADE, related_name='lignes')
    no_ligne = models.IntegerField()
    id_produit = models.ForeignKey(Produit, on_delete=models.SET_NULL, null=True, related_name='lignes_transactions')
