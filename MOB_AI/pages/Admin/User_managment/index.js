...
const UserManagement = ({ user: currentUser }) => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      // If we're here, it means both network and cache failed
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              await userService.patchUser(user.id_utilisateur, { is_banned: !user.is_banned });
              fetchUsers();
            } catch (error) {
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              await userService.deleteUser(user.id_utilisateur);
  ...
  const handleSave = async () => {
    ...
    try {
      if (editingUser) {
        // Edit existing user
        await userService.updateUser(editingUser.id_utilisateur, formData);
      } else {
